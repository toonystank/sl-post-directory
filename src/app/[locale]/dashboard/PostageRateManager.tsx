...
import { Save, Plus, Trash2, ChevronDown, ChevronRight, Calculator } from "lucide-react";
...
export default function PostageRateManager() {
    ...
    if (loading) return <div className="text-center py-10 text-muted-foreground animate-pulse">Loading rate configuration...</div>;
    ...
    return (
        <Card className="border-border/50">
            <CardHeader className="border-b border-border/40 bg-card/80">
                ...
                <CardDescription>Configure dynamic pricing for all postal services.</CardDescription>
                <div className="flex gap-2 pt-4 border-b border-border/40 overflow-x-auto pb-1">
                ...
                {activeTab === "domestic" && (
                    <div className="space-y-6">
                        ...
                        {domesticServices.map((service, sIdx) => (
                            <div key={service.id} className="border border-border/50 rounded-xl overflow-hidden">
                                <div 
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            {emsCountries.map((country, cIdx) => (
                                <div key={cIdx} className="grid grid-cols-[100px_1fr_150px_auto] items-center gap-4 border border-border/50 p-2 rounded-lg bg-muted/20">
                                    <Input 
                                        value={country.code}
                                        onChange={(e) => {
