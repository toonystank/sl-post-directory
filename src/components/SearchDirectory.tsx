...
export default function SearchDirectory() {
    ...
    useEffect(() => {
        const handleClickOutside = (event: MouseEvent) => {
            ...
            if (!clickedInPrimary && !clickedInSticky) {
                setShowSuggestions(false);
            }
        };
        ...
        <div className="w-full">
            <div className={`bg-background/90 backdrop-blur-md border shadow-sm flex items-center gap-2 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 transition-all ${isSticky ? 'rounded-b-2xl p-2 px-3' : 'rounded-xl p-1.5'}`}>
                ...
                <div className="flex items-center gap-1.5 pr-1">
                    ...
                    {query && (
                        <button onClick={clearSearch} className="p-1.5 rounded-lg hover:bg-muted text-muted-foreground hover:text-foreground transition-colors mr-1">
                            <X className="w-4 h-4" />
                        </button>
                    )}
                    <Button
    ...
    const renderMobileFilters = () => (
        <div className="block lg:hidden w-full mt-4 text-left">
            ...
            <div className="container mx-auto px-4 py-8 md:py-10 relative z-20">
                ...
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                    ...
                    <aside
                        ...
                        className="hidden lg:flex flex-col w-full lg:w-80 flex-shrink-0 lg:sticky lg:top-24 bg-card/60 backdrop-blur-xl border border-border/50 rounded-2xl p-4 lg:p-5 shadow-2xl transition-all lg:max-h-[calc(100vh-6.5rem)] lg:overflow-y-auto lg:overflow-x-hidden scrollbar-hide"
